 ...
 */
const getGeminiResponse = (userId, message) => __awaiter(this, void 0, void 0, function* () {
    try {
        ...
        try {
            if (redisClient.isOpen) {
                const data = yield redisClient.get(historyKey);
        ...
        try {
            if (redisClient.isOpen) {
                yield redisClient.setEx(historyKey, 86400, JSON.stringify(history));
            }
            else {
 ...
 */
const clearHistory = (userId) => __awaiter(this, void 0, void 0, function* () {
    try {
        const historyKey = `chat_history:${userId}`;
        if (redisClient.isOpen) {
            yield redisClient.del(historyKey);
        }
