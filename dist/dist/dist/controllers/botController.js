 ...
 */
const getBotResponse = (userId, text) => __awaiter(this, void 0, void 0, function* () {
    try {
        // Try Gemini first
        if (process.env.GEMINI_API_KEY) {
            return yield getGeminiResponse(userId, text);
        }
    }
    catch (error) {
 ...
 */
const handleBotMessage = (io, senderId, text, botUser) => __awaiter(this, void 0, void 0, function* () {
    try {
        // 1. Analyze sentiment of user's message
        let sentimentEmoji = '';
        try {
            const sentiment = yield analyzeSentiment(text);
        ...
        setTimeout(() => __awaiter(this, void 0, void 0, function* () {
            ...
            setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                ...
                // 4. Send Message
                const message = yield messageService.sendMessage(botUser._id, senderId, responseText, false);
