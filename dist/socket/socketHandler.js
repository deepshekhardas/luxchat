    ...
    io.on('connection', (socket) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        socket.on('message.send', (data) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                ...
                const message = yield messageService_1.default.sendMessage(socket.user.id, targetId, text, isGroup);
                // Determine Room ID
                ...
                if (!isGroup) {
                    const targetUser = yield User_1.default.findById(targetId);
        ...
        socket.on('message.read', (data) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            try {
                if (targetId) {
                    yield messageService_1.default.markAsRead(targetId, socket.user.id, isGroup);
        ...
        socket.on('disconnect', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const user = yield User_1.default.findById(socket.user.id);
            if (user) {
                user.status = 'offline';
