...
describe('MessageService', () => {
    ...
    describe('sendMessage', () => {
        it('should send a direct message successfully', async () => {
            ...
            const result = await messageService.sendMessage('user1', 'conv123', 'Hello!');
        ...
        it('should send a group message successfully', async () => {
            ...
            const result = await messageService.sendMessage('user1', 'group123', 'Hello Group!', [], true);
        ...
        it('should throw error if group not found', async () => {
            ...
            await expect(messageService.sendMessage('user1', 'invalidGroup', 'Hi', [], true))
        ...
        it('should throw error if user is not a group member', async () => {
            ...
            await expect(messageService.sendMessage('user1', 'group123', 'Hi', [], true))
        ...
        it('should throw error if conversation not found', async () => {
            ...
            await expect(messageService.sendMessage('user1', 'invalidConv', 'Hi'))
    ...
    describe('getMessages', () => {
        it('should return messages for a conversation', async () => {
            ...
            const result = await messageService.getMessages('conv123', false, 50, 0);
        ...
        it('should return messages for a group', async () => {
            ...
            await messageService.getMessages('group123', true);
    ...
    describe('markAsRead', () => {
        it('should mark messages as read and reset unread count', async () => {
            ...
            await messageService.markAsRead('conv123', 'user1', false);

            expect(Message.updateMany).toHaveBeenCalledWith(
                { conversation_id: 'conv123', sender: { $ne: 'user1' }, status: { $ne: 'read' } },
                { $set: { status: 'read' } }
            );
