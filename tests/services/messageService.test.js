...
describe('MessageService', () => {
  ...
  describe('sendMessage', () => {
    it('should send a direct message successfully', async () => {
      ...
      await messageService.sendMessage('user1', 'conv123', 'Hello!');
    ...
    it('should send a group message successfully', async () => {
      ...
      await messageService.sendMessage('user1', 'group123', 'Hello Group!', [], true);
    ...
    it('should throw error if group not found', async () => {
      ...
      await expect(
        messageService.sendMessage('user1', 'invalidGroup', 'Hi', [], true)
    ...
    it('should throw error if user is not a group member', async () => {
      ...
      await expect(messageService.sendMessage('user1', 'group123', 'Hi', [], true)).rejects.toThrow(
    ...
    it('should throw error if conversation not found', async () => {
      ...
      await expect(messageService.sendMessage('user1', 'invalidConv', 'Hi')).rejects.toThrow(
